...
class NewUserRequest {
  ...
  @override
  String toString() => 'NewUserRequest[name=$name, email=$email]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NewUserRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NewUserRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
